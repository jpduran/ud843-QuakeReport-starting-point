...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestURL){
        ...
        try{
            jsonResponse = networkRequest(url);
        } catch (IOException e){
    ...
    private static String networkRequest(URL url) throws IOException {
        String jsonResponse = "";
        ...
        try{
            ...
            Log.e(LOG_TAG, "Problem retrieving the earthqueakes JSON result.", e);
        } finally {
